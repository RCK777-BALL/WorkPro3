...
export const createLine = async (req, res, next) => {
    try {
        ...
        department.lines.push({ name, tenantId: req.tenantId, stations: [] });
...
export const getLinesByDepartment = async (req, res, next) => {
    try {
        const department = await Department.findOne({
...
export const getLineHierarchy = async (req, res, next) => {
    try {
        const department = await Department.findOne({
            'lines._id': req.params.id,
            tenantId: req.tenantId,
