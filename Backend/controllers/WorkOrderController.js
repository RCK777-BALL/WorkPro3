...
function toWorkOrderUpdatePayload(doc) {
 ...
 */
export const searchWorkOrders = async (req, res, next) => {
    try {
...
export const updateWorkOrder = async (req, res, next) => {
    try {
        ...
        const updated = await WorkOrder.findOneAndUpdate({ _id: req.params.id, tenantId: req.tenantId }, req.body, {
            new: true,
            runValidators: true,
        });
        if (!updated)
 ...
 *         description: Work order not found
 */
export const approveWorkOrder = async (req, res, next) => {
    try {
 ...
 *         description: Work order not found
 */
export const assistWorkOrder = async (req, res, next) => {
    try {
