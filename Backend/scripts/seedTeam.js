...
const seedTeam = async () => {
    try {
        ...
        // Team hierarchy
        const departmentLeader = await TeamMember.findOneAndUpdate({ email: "deptleader@example.com" }, {
        ...
        const areaLeader = await TeamMember.findOneAndUpdate({ email: "arealeader@example.com" }, {
            name: "Area Leader",
        ...
        const teamLeader = await TeamMember.findOneAndUpdate({ email: "teamleader@example.com" }, {
            name: "Team Leader",
        ...
        await TeamMember.findOneAndUpdate({ email: "member1@example.com" }, {
        ...
        await TeamMember.findOneAndUpdate({ email: "member2@example.com" }, {
