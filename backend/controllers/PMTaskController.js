...
export const getAllPMTasks = async (req, res, next) => {
    try {
...
export const getPMTaskById = async (req, res, next) => {
    try {
...
export const createPMTask = async (req, res, next) => {
    try {
...
export const updatePMTask = async (req, res, next) => {
    try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
            return res.status(400).json({ errors: errors.array() });
...
export const deletePMTask = async (req, res, next) => {
    try {
