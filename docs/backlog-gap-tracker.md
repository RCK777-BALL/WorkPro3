...
| BGT-066 | Infra / Deployment | Parameterize Ingress/TLS/app URL hostnames to remove hard-coded placeholder domains in manifests.【F:docs/executable_tasks.md†L215-L222】 | Sprint 24.36 | Scheduled |
| BGT-067 | Infra / Deployment | Document production domain/TLS setup, DNS prerequisites, and secret/issuer configuration guidance.【F:docs/executable_tasks.md†L223-L228】 | Sprint 24.36 | Scheduled |
