    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <h1 className="text-2xl font-semibold text-neutral-900 dark:text-white">Workflow rules</h1>
          <p className="text-sm text-neutral-500">Approval steps, SLA timers, escalation paths, and templates.</p>
        </div>
      ...
      <Card title="Approvals" subtitle="Define sequential approvers" icon={<Shield className="h-5 w-5 text-primary-500" />}>
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-200">Rule name</label>
            <input
            ...
            />
            <p className="text-xs text-neutral-500">Shown in audit logs and comments.</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-200">Scope</label>
            <select
              className="mt-1 w-full rounded-md border border-neutral-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none dark:border-neutral-700 dark:bg-neutral-800"
              value={draft.scope}
        ...
        <div className="mt-3 rounded-md bg-neutral-50 p-3 text-sm text-neutral-700 dark:bg-neutral-800 dark:text-neutral-200">
      ...
      <Card title="SLA timers" subtitle="Response and completion targets" icon={<Clock className="h-5 w-5 text-amber-500" />}>
        <div className="grid gap-4 md:grid-cols-3">
          <div>
            <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-200">Response minutes</label>
            <input
              type="number"
              className="mt-1 w-full rounded-md border border-neutral-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none dark:border-neutral-700 dark:bg-neutral-800"
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-200">Resolve minutes</label>
            <input
              type="number"
              className="mt-1 w-full rounded-md border border-neutral-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none dark:border-neutral-700 dark:bg-neutral-800"
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-200">Backoff (minutes)</label>
            <input
              type="number"
              className="mt-1 w-full rounded-md border border-neutral-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none dark:border-neutral-700 dark:bg-neutral-800"
      ...
      >
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-200">Email subject</label>
            <input
              className="mt-1 w-full rounded-md border border-neutral-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none dark:border-neutral-700 dark:bg-neutral-800"
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-200">SMS body</label>
            <input
              className="mt-1 w-full rounded-md border border-neutral-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none dark:border-neutral-700 dark:bg-neutral-800"
          ...
          <div className="md:col-span-2">
            <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-200">Email body</label>
            <textarea
              className="mt-1 w-full rounded-md border border-neutral-300 px-3 py-2 text-sm focus:border-primary-500 focus:outline-none dark:border-neutral-700 dark:bg-neutral-800"
              rows={4}
      ...
      <Card title="Existing rules" subtitle="Overrides are sorted by recency" icon={<ArrowUpCircle className="h-5 w-5" />}>
        <div className="space-y-3">
          {rules.map((rule) => (
            <div
              key={rule._id}
              className="rounded-md border border-neutral-200 bg-white/60 p-3 text-sm dark:border-neutral-700 dark:bg-neutral-800"
            >
              <div className="flex items-center justify-between">
                <div className="font-semibold text-neutral-900 dark:text-white">{rule.name}</div>
